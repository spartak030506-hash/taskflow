...
class TestCreateComment:
    ...
    def test_create_comment_notifies_assignee(self):
        ...
        with patch('apps.comments.services.send_comment_notification_to_assignee.delay') as mock_notify:
    ...
    def test_create_comment_notifies_creator(self):
        ...
        with patch('apps.comments.services.send_comment_notification_to_creator.delay') as mock_notify:
            services.create_comment(
                task=task,
                author=commenter,
                content='Comment',
    ...
    def test_create_comment_no_duplicate_notifications(self):
        ...
        with patch('apps.comments.services.send_comment_notification_to_assignee.delay') as mock_assignee:
            with patch('apps.comments.services.send_comment_notification_to_creator.delay') as mock_creator:
                services.create_comment(
                    task=task,
                    author=project.owner,
                    content='Comment',
